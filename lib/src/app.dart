        ...
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            image: DecorationImage(
                image: AssetImage('imagenes/degra4.jpg'), fit: BoxFit.fill),
          ),
        ),
        backgroundColor: Color.fromARGB(255, 3, 158, 86),
        centerTitle: true,
        title: const Text(
          "Datos personales",
              ...
              Row(
                  ...
                  children: <Widget>[
                    ...
                    Card(
                      ...
                      width: 500,
                      height: 150,
                      child: Text('''Nombre: Brianda Itzel Martinez Guzman
Genero: Mujer
Edad: 21 años
Correo: briandaitzel.guzman@gmail.com ''',
                          style: TextStyle(
            ...
            Row(
              children: [
                FloatingActionButton(
                  backgroundColor: Color.fromARGB(255, 248, 172, 7),
                ...
                FloatingActionButton(
                  backgroundColor: Color.fromARGB(255, 13, 210, 245),
                ...
                FloatingActionButton(
                  backgroundColor: Color.fromARGB(255, 236, 5, 75),
